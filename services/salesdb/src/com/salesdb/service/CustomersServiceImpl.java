...
public class CustomersServiceImpl implements CustomersService {
    ...
    @Transactional(readOnly = true, value = "salesdbTransactionManager")
	@Override
	public Customers getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Customers by unique keys: {}", uniqueyKeyFieldsVsValues);
        Customers customers = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (customers == null){
            LOGGER.debug("No Customers found with given unique key values: {}", uniqueyKeyFieldsVsValues);
