...
public class TasksServiceImpl implements TasksService {
    ...
    @Transactional(readOnly = true, value = "salesdbTransactionManager")
	@Override
	public Tasks getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Tasks by unique keys: {}", uniqueyKeyFieldsVsValues);
        Tasks tasks = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (tasks == null){
            LOGGER.debug("No Tasks found with given unique key values: {}", uniqueyKeyFieldsVsValues);
