...
public class StatesServiceImpl implements StatesService {
    ...
    @Transactional(readOnly = true, value = "salesdbTransactionManager")
	@Override
	public States getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding States by unique keys: {}", uniqueyKeyFieldsVsValues);
        States states = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (states == null){
            LOGGER.debug("No States found with given unique key values: {}", uniqueyKeyFieldsVsValues);
