...
public class FollowUpsServiceImpl implements FollowUpsService {
    ...
    @Transactional(readOnly = true, value = "salesdbTransactionManager")
	@Override
	public FollowUps getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding FollowUps by unique keys: {}", uniqueyKeyFieldsVsValues);
        FollowUps followups = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (followups == null){
            LOGGER.debug("No FollowUps found with given unique key values: {}", uniqueyKeyFieldsVsValues);
