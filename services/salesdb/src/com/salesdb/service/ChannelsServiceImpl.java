...
public class ChannelsServiceImpl implements ChannelsService {
    ...
    @Transactional(readOnly = true, value = "salesdbTransactionManager")
	@Override
	public Channels getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Channels by unique keys: {}", uniqueyKeyFieldsVsValues);
        Channels channels = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (channels == null){
            LOGGER.debug("No Channels found with given unique key values: {}", uniqueyKeyFieldsVsValues);
