...
public class ProductsServiceImpl implements ProductsService {
    ...
    @Transactional(readOnly = true, value = "salesdbTransactionManager")
	@Override
	public Products getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Products by unique keys: {}", uniqueyKeyFieldsVsValues);
        Products products = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (products == null){
            LOGGER.debug("No Products found with given unique key values: {}", uniqueyKeyFieldsVsValues);
