...
public class QuotesServiceImpl implements QuotesService {
    ...
    @Transactional(readOnly = true, value = "salesdbTransactionManager")
	@Override
	public Quotes getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Quotes by unique keys: {}", uniqueyKeyFieldsVsValues);
        Quotes quotes = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (quotes == null){
            LOGGER.debug("No Quotes found with given unique key values: {}", uniqueyKeyFieldsVsValues);
