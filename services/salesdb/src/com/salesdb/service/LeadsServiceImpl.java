...
public class LeadsServiceImpl implements LeadsService {
    ...
    @Transactional(readOnly = true, value = "salesdbTransactionManager")
	@Override
	public Leads getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Leads by unique keys: {}", uniqueyKeyFieldsVsValues);
        Leads leads = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (leads == null){
            LOGGER.debug("No Leads found with given unique key values: {}", uniqueyKeyFieldsVsValues);
