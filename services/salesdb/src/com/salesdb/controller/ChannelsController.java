...
public class ChannelsController {
    ...
    public Page<Channels> findChannels(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
    ...
    public Channels editChannels(@PathVariable(value = "id") Integer id, @RequestBody Channels channels) throws EntityNotFoundException {
