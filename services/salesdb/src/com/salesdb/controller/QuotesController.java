...
public class QuotesController {
    ...
    public Page<FollowUps> findAssociatedFollowUpses(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    public Quotes editQuotes(@PathVariable(value = "id") Integer id, @RequestBody Quotes quotes) throws EntityNotFoundException {
    ...
    public boolean deleteQuotes(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
