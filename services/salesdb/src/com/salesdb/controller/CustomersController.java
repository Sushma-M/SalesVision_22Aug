...
public class CustomersController {
    ...
    public Page<Customers> findCustomers(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
    ...
    public Customers editCustomers(@PathVariable(value = "id") Integer id, @RequestBody Customers customers) throws EntityNotFoundException {
