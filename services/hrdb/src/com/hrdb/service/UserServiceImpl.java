...
public class UserServiceImpl implements UserService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
	@Override
	public User getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding User by unique keys: {}", uniqueyKeyFieldsVsValues);
        User user = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (user == null){
            LOGGER.debug("No User found with given unique key values: {}", uniqueyKeyFieldsVsValues);
