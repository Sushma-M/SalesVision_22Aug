...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
	@Override
	public Department getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Department by unique keys: {}", uniqueyKeyFieldsVsValues);
        Department department = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (department == null){
            LOGGER.debug("No Department found with given unique key values: {}", uniqueyKeyFieldsVsValues);
    ...
    @Override
    public Page<Employee> findAssociatedEmployees(Integer id, Pageable pageable) {
