...
public class VacationServiceImpl implements VacationService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
	@Override
	public Vacation getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Vacation by unique keys: {}", uniqueyKeyFieldsVsValues);
        Vacation vacation = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (vacation == null){
            LOGGER.debug("No Vacation found with given unique key values: {}", uniqueyKeyFieldsVsValues);
