...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
	@Override
	public Employee getByUniqueKey(Map<String, Object> uniqueyKeyFieldsVsValues) throws EntityNotFoundException {
        LOGGER.debug("Finding Employee by unique keys: {}", uniqueyKeyFieldsVsValues);
        Employee employee = this.wmGenericDao.findByUniqueKey(uniqueyKeyFieldsVsValues);
        if (employee == null){
            LOGGER.debug("No Employee found with given unique key values: {}", uniqueyKeyFieldsVsValues);
    ...
    @Override
    public Page<Employee> findAssociatedEmployeesForManagerid(Integer id, Pageable pageable) {
        LOGGER.debug("Fetching all associated employeesForManagerid");
        return findAssociatedValues(id, "employeeByManagerid", "eid", pageable);
    }

    @Override
    public Page<Vacation> findAssociatedVacations(Integer id, Pageable pageable) {
